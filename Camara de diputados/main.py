    ...
    def OnTimer(self, event):
        ...
        if self.analisis==True:
          if self.FRECUENCIA_CNN==0: 
              ...
              cv2.imwrite('C:/Users/Administrador/Desktop/Camara de diputados/frames/imagen_' + str('{0:0{width}}'.format(self.imagenes,width=10)) + '.jpg',self.image_np2)
