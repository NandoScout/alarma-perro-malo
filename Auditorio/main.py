    ...
    def OnTimer(self, event):
        ...
        if self.analisis==True:
          if self.FRECUENCIA_CNN==0: 
              ...
              self.image_np2 = cv2.rotate(self.image_np2, rotateCode=cv2.ROTATE_180)
              self.image_np2 = cv2.flip(self.image_np2, flipCode=1)
              ...
              cv2.imwrite('C:/Users/Administrador/Desktop/Auditorio/frames/imagen_' + str('{0:0{width}}'.format(self.imagenes,width=10)) + '.jpg',self.image_np2)
